...
// Element Class 
class vcSingleChannel extends WPBakeryShortCode {
     
    // Element Init
    function __construct() {
        add_action( 'init', array( $this, 'vc_singleChannel_mapping' ) );
        add_shortcode( 'vc_singleChannel', array( $this, 'vc_singleChannel_html' ) );
    }
     
    // Element Mapping
    public function vc_singleChannel_mapping() {
        ...
        vc_map( 
            array(
                'name' => __('Single Channel', 'text-domain'),
                'base' => 'vc_singleChannel',
    ...
    // Element HTML
    public function vc_singleChannel_html( $atts ) {
    ...
    public function BlockHTML( $title, $subtitle, $image, $link ) { 
        ...
        <div class="single-channel-item-container">
            ...
            <?php endif; ?>
                    ...
                    <div class="single-channel-item" style="background-image:url(<?php echo $image[0]; ?>)">
