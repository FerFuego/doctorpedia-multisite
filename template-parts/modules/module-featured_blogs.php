<?php
    ...
    $post_articles = get_sub_field('articles');
?>
<section class="featured-blogs" id="js-featuredBlogsModule">
    <div class="container">
        <?php if ( $title ) : ?>
        ...
        <div class="slider-container slider_<?php echo $slider_id ?>" id="slider_<?php echo $slider_id ?>">
            ...
            <?php if ( count($post_articles) > 0 ) : 
                foreach ( $post_articles as $article ) : 
                    set_query_var('article', $article['article']);
